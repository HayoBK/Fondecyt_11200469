...
file_path = Py_Processing_Dir + "H_Obsession_SimianMaze_ShortDf_Normalized.csv"
navi_df = pd.read_csv(file_path)
Banish_List =['P02','P03','P13','P06','P07']
navi_df = navi_df[~navi_df['Sujeto'].isin(Banish_List)]
print(Banish_List)
