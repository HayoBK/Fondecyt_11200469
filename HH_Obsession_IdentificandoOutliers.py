...
file = os.path.join(Py_Processing_Dir, "C2_Obsession_SimianMaze_Z3_Resumen_Short_df.csv")
df = pd.read_csv(file)
...
filtered_file = os.path.join(Py_Processing_Dir, "H_Obsession_SimianMaze_ShortDf_NoOutliers.csv")
