...
file = os.path.join(Py_Processing_Dir, "H_Obsession_SimianMaze_ShortDf_NoOutliers.csv")
df = pd.read_csv(file)
...
output_file = os.path.join(Py_Processing_Dir, "H_Obsession_SimianMaze_ShortDf_Normalized.csv")
